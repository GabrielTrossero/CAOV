                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/alquilermueble/edit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="fechaSol" id="fechaSol" class="form-control" value="2019-03-27">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" value="10" name="cantTablones" id="cantTablones" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" value="30" name="cantSillas" id="cantSillas" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" value="10" name="cantCaballetes" id="cantCaballetes" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="fechaRea" id="fechaRea" class="form-control" value="2019-05-05">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="costoTotal" id="costoTotal" class="form-control" value="1200">
                            </div>
                        </div>
