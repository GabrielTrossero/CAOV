...
class BackupJob
{
    ...
    /** @var bool */
    protected $sendNotifications = false; // en false no se envian notificaciones al mail
    ...
    public function setDefaultFilename(): self
    {
        ...
        //modificado porque en config/backup.php ya se agrega el nombre del comprimido
        $this->filename = '.zip';
